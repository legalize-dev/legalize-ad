...
S'aprova el Reglament del sistema de gestió i avaluació de l'acompliment, que entrarà en vigor a l'endemà de la seva publicació al Butlletí Oficial del Principat d'Andorra.
...
b) Cada objectiu té una ponderació, que ha de ser superior al 15% i igual o inferior al 50%. La suma de les ponderacions dels objectius fixats ha de donar 100%. La distribució de les ponderacions entre els objectius depèn de la prioritat i importància dels objectius a partir de les línies d'actuació departamentals.
...
2. Per a les famílies de llocs de treball de l'Administració general, l'acompliment total es determina segons el quadre de ponderacions per a l'Administració general (cos general i cossos especials) que es relaciona en l'annex núm. 1.
...
2. Aquest complement de millora retribueix el desenvolupament professional en el lloc de treball, en funció de la contribució rellevant i individual de l'empleat de l'Administració general, a través del seu acompliment. És un complement retributiu que es consolida, amb caràcter fix.
...
2. Durant els mesos de juny, juliol i agost, el gestor de l'acompliment convoca el col·laborador a l'entrevista de seguiment, on constata el nivell d'assoliment dels objectius i les conductes fins a la data; i emplenen i signen el full de seguiment d'objectius i conductes.

3. Posteriorment, l'alt càrrec valida o retorna motivadament el full de seguiment d'objectius i de conductes, degudament emplenat pel gestor de l'acompliment i pel col·laborador, i el tramet a l'Àrea de Desenvolupament de Recursos Humans.
...
3. La conversió dels nivells d'acompliment ponderat en percentatges d'augment retributiu s'efectua mitjançant la taula de conversió que es relaciona en l'annex núm. 5.

##### Article 25

Càlcul del complement de millora El càlcul del complement de millora s'obté multiplicant el percentatge d'augment de la taula de conversió per la suma dels complements retributius següents: base retributiva, complement de lloc, complement de millora i, si escau, complement específic.
...
Còmput del temps efectivament treballat 1. L'empleat de l'Administració general que no hagi treballat de manera efectiva més del 80% de la seva jornada habitual de treball, dins del cicle de gestió corresponent, assoleix una puntuació de "zero".

2. El còmput per al Cos especial d'ensenyament és proporcional als dies lectius del calendari escolar, per la qual cosa l'empleat adscrit al Cos especial d'ensenyament que no hagi treballat de manera efectiva dins del cicle de gestió corresponent un mínim del 80% dels dies lectius, assoleix una puntuació de "zero".
...
Els col·laboradors en període de prova no perceben l'aplicació retributiva del GAdA.
...
Andorra la Vella, 9 de juliol del 2003 Marc Forné Molné Cap de Govern

#### Annex 1

Escala de ponderacions d'objectius i competències Tipus de família de llocs de treball Ponderació Objectius Ponderació Competències Director100% * Cap d’Àrea60% 40% Cap d’Unitat50% 50% Responsable50% 50% Encarregat35% 65% Tècnic50% 50% Tècnic suport/Tècnic25% 75% Administratiu25% 75% Administratiu20% 80% Operari10% 90% Suport10% 90%

#### Annex 2

Escala de puntuació d'objectius Clau Grau Valor absolut I Insuficient0 P Parcialment assolit5 A Assolit satisfactòriament10 E Excel·lent12

#### Annex 3

Escala de puntuació de competències Clau Grau Valor absolut Poc- 0 + 4 Normal- 6 + 8 Molt- 10 + 12

#### Annex 4

Taula d'intervals d'acompliment Nivell d’acompliment Intervals d’acompliment Insuficient0 - 48 Millorable49 - 65 Acceptable66 - 78 Molt bo79 - 100 Excepcional101 - 120

#### Annex 5

Taula de conversió d'acompliment ponderat en augments retributius Nivell d’acompliment ponderat Intervals d’acompliment ponderat (mitjana de dos cicles de gestió) Augment retributiu normal (en %) Augment retributiu per a empleats en absorció (en %) Insuficient0 - 48 0% 0% Millorable49 - 65 0% 0% Acceptable66 - 78 2% 0% Molt bo79 - 100 4% 2% Excepcional101 - 120 6% 4%
