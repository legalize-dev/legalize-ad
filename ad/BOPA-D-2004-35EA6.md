---
title: "Decret del 19-5-2004 pel qual s'aprova el Reglament d'ajuts a l'estudi"
identifier: "BOPA-D-2004-35EA6"
country: "ad"
rank: "reglament"
publication_date: "2004-05-25"
last_updated: "2004-05-25"
status: "in_force"
source: "https://www.bopa.ad/bopa/016032/Pagines/35EA6.aspx"
department: "Govern del Principat d'Andorra"
signature_date: "2004-05-18"
bopa_issue: "BOPA 32/2004"
bopa_document_id: "35EA6"
---
...
c) En ensenyaments universitaris i assimilats no presencials, l'alumne no es matriculi a un mínim de tres assignatures o a trenta-sis crèdits anyals o, havent- ho fet, no els aprovi.
...
3. Les despeses suplementàries que es puguin derivar en l'àmbit educatiu de la discapacitat de cada persona són acumulables amb les ajudes i les beques establertes en aquest Reglament, sempre que hagin estat declarats legalment per la CONAVA com a persones amb discapacitat.
...
Es poden determinar nivells màxims específics per als diferents tipus d'ajuts i per a cada nivell educatiu i país on en cursi.
...
Estudis emparables pels crèdits d'estudi 1. Només pot justificar la sol·licitud d'atorgament d'un crèdit dels regulats als articles 21 i successius de la Llei d'ajuts a l'estudi el fet de cursar estudis universitaris i assimilats i de formació professional que es corresponguin amb un pla d'estudis o un currículum aprovat per l'autoritat competent en el país on es realitzen i al final dels quals s'obtingui un títol amb validesa acadèmica a Andorra.
...
2. No obstant l'apartat anterior, es poden atorgar crèdits per al pagament de la matrícula d'imports superiors si el sol·licitant ho justifica convenientment i es correspon a un ensenyament que sigui d'interès per al sistema econòmic, social o cultural andorrà, o s'imparteix en un centre universitari d'unes característiques pròpies prou rellevants com perquè justifiqui que un estudiant andorrà hi cursi els estudis. En aquests supòsits, la decisió que s'adopti serà motivada i raonada pel ministeri competent en matèria educativa que determina l'import d'aquests crèdits en la resolució d'atorgament.

##### Article 28

Determinació de l'import del crèdit d'estudis El Govern estableix anualment l'import del crèdit d'estudis d'acord amb la proposta que li formula el ministeri competent en matèria educativa. Aquesta proposta ha de cobrir els imports dels següents:
...
Quan aquest atorgament es produeixi amb posterioritat a la presentació de la seva sol·licitud, ho ha de posar en coneixement del ministeri competent en matèria educativa, abans que no transcorri un mes des que aquest atorgament es produeixi.
...
Els crèdits d'estudis atorgats d'acord amb la normativa anterior a la Llei d'ajuts a l'estudi seguiran regint-se per la normativa que els era d'aplicació en el moment del seu atorgament.

Cosa que es fa pública per a coneixement general.

Andorra la Vella, 19 de maig del 2004 Marc Forné Molné Cap de Govern
...
b.1) fins el salari mínim mensual x 12 b.2) fins el salari mínim mensual x 12 x 1,5 b.3) fins el salari mínim mensual x 12 x 2 b.4) fins el salari mínim mensual x 12 x 2,5 b.5) fins el salari mínim mensual x 12 x 3 b.6) fins el salari mínim mensual x 12 x 3,5 b.7) més del salari mínim mensual x 12 x 3,5 c) Rendes de les activitats econòmiques de la unitat familiar:
...
h.1) la família no té cap vehicle h.2) unitat familiar d'un sol membre major d'edat amb un únic automòbil de turisme de 1500 cc o menys i sense motocicletes de més de 125 cc h.3) unitat familiar de 2 o més membres majors d'edat amb un o dos automòbils de turisme de 1500 cc o menys i sense motocicletes de més de 125 cc h.4) unitat familiar amb més vehicles terrestres, marítims o aeris dels ressenyats als apartats anteriors 4. Criteris acadèmics a) Expedient acadèmic de la persona sol·licitant:

a.1) Ensenyaments de batxillerat o de formació professional:

a.1.1) nota mitjana de 5 o 6 en els sistemes andorrà i espanyol, i de 10 a 12, ambdós inclosos, en el sistema francès a.1.2) nota mitjana de més de 6 i menys de 9 en els sistemes educatius andorrà i espanyol, i 12 a 16 en el sistema educatiu francès a.1.3) nota mitjana de 9 a 10, en els sistemes andorrà i espanyol, i de més de 16 a 20 en el sistema francès a.1.4) nota mitjana d'excel·lent, en el sistema andorrà, "sobresaliente", en el sistema espanyol, i mention très bien, en el sistema francès a.2) Ensenyaments universitaris i assimilats:
